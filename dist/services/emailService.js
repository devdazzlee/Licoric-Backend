...
exports.emailTemplates = {
  ...
  `,
    wholesaleConfirmation: (customerData) => `
    <!DOCTYPE html>
    <html>
    <head>
      <style>
  ...
  `,
    contactFormNotification: (contactData) => `
    <!DOCTYPE html>
    <html>
    <head>
      <style>
  ...
  `,
    contactFormConfirmation: (customerData) => `
    <!DOCTYPE html>
    <html>
    <head>
      <style>
  ...
  `,
    newsletterSubscriptionNotification: (subscriberData) => `
    <!DOCTYPE html>
    <html>
    <head>
      <style>
