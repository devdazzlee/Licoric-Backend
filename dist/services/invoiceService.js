    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc
                .fontSize(20)
                .fillColor('#E85A2D')
                .text('LICORICE ROPES', 50, 50)
                .fontSize(10)
                .fillColor('#666')
                .text('123 Candy Lane', 50, 75)
                .text('Sweet City, SC 12345', 50, 88)
                .text('Phone: +1 (555) 123-4567', 50, 101)
                .text('Email: support@licoriceropes.com', 50, 114);
            doc
                .fontSize(25)
                .fillColor('#000')
